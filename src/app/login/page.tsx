    ...
    <main className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-[420px]">
        ...
        <button
          ...
          className="w-full py-3 mb-4 bg-surface border-[0.5px] border-black/20 rounded-lg text-sm font-medium flex items-center justify-center gap-3 active:scale-[0.98] transition-transform"
        >
